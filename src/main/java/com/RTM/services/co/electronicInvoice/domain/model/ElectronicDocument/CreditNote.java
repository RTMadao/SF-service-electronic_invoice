...
import com.RTM.services.co.electronicInvoice.domain.model.AppendDocument.BillingReferenceInvoice;
...
public class CreditNote extends ElectronicDocument{
    ...
    public String getProfileID() {
        return profileID+": Nota Crédito de Factura Electrónica de Venta";
    }
    ...
    public String getDocumentName(String assignCode, String fileNumber){
        ...
        return "nc"+nit+assignCode+ DataFormatService.setYearLastDigitFormat(new Date())+fileNumber;
    }
