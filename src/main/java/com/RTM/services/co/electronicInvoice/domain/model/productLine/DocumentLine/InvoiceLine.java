...
import com.RTM.services.co.electronicInvoice.domain.model.productLine.DocumentLine.DocumentLine;
...
public class InvoiceLine implements DocumentLine {
    private LineID ID;
    private String note;
    private Unit invoicedQuantity;
    ...
    public InvoiceLine(LineID ID, String note, Unit invoicedQuantity, Money lineExtensionAmount, PricingReference pricingReference, List<AllowanceCharge> allowanceCharge, List<TaxTotal> taxTotals, Item item, Price price) {
        this.ID = ID;
        this.note = note;
    ...
    @Override
    @XmlElement(name = "InvoicedQuantity", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents‐2")
    ...
    public void setInvoicedQuantity(Unit invoicedQuantity) {
        this.invoicedQuantity = invoicedQuantity;
    }
